...
<div class="aboutText">
    ...
    <asp:Panel runat="server" ID="pnlPrivacy" Visible="false">
        ...
        <h3 class="mt-4">3. General information on data processing</h3>
        ...
        <h3 class="mt-4">4. Provision of the website and creation of log files</h3>
        ...
        <a id="cookies" name="coookies"></a>
        <h3 class="mt-4">5. Use of cookies</h3>
        ...
        internet browser in the user’s computer system. If a user visits a website, a cookie may be stored 
        in the user’s operating system. This cookie contains a characteristic character string that enables 
        a unique identification of the browser when the website is accessed again.
        
        <p>We use cookies to make our website more user-friendly. Some elements of our website require that 
        the accessing browser can be identified even after a page change.</p>
        
        The website is powered by <a href="https://profiles.catalyst.harvard.edu/" target="_blank">Profiles RNS</a> 
        which stores and transmits these cookies:</p>

        <ul>
            <li>
                <b>Browser Session</b>: Help individual web pages to load faster and improve navigation through 
                our website. Each time your browser requests a web page from the server, it includes the session 
                cookie file with its request. The cookie lets the server know which page components the browser 
                has already been sent, so the server doesn't have to re-send them. When the browser closes at the 
                end of a session, the file is deleted.
            </li>
        </ul>
