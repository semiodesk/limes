...
WHERE
    ...
    AND i.methodName = '[Profile.Data].[Publication.Pubmed.LoadDisambiguationResults]'
    AND (pm.ArticleYear IS NOT NULL OR pm.JournalYear IS NOT NULL OR fa.StartDate IS NOT NULL)
